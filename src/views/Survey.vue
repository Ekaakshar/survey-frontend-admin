            ...
            <div v-if="question.type === 'BOOLEAN'">
                <div class="" v-for='(option, index) in question.options' :key="index">
                  <p class="radio-option">
                     <label>
                    <input type="radio" :value="option.body" :name="question.id" v-model="question.answer">
                   {{option.body}}</label>
                  </p>
                </div>
              </div>
              <div class="option-section" v-if="question.type === 'DATE'">
                  <input type="date" class="input-text " placeholder="" :name="question.id" v-model="question.answer" >
              </div>
              <div class="option-section" v-if="question.type === 'TIME'">
                  <input type="time" class="input-text " placeholder="" :name="question.id" v-model="question.answer" >
              </div>
              <div class="option-section" v-if="question.type === 'NUMBER'">
                <div class="">
                  <input type="number" class="input-text  width-100" v-model="question.answer" :min="question.minValue" :max="question.maxValue">
              ...
              <div class="option-section" v-if="question.type === 'SINGLE_CHOICE'">
                <div v-for='(option, index) in question.options' :key="index">
                  <label>
                    <input type="radio" :value="option.body" :name="question.id" v-model="question.answer">&nbsp;{{option.body}}
                  </label>
              ...
              <div class="option-section" v-if="question.type === 'MULTI_CHOICE'">
                <div v-for='(option, index) in question.options' :key="index">
                  <label>
                    <input type="checkbox" :id="question.id + option.sequence" :value="option.body" :name="question.id + '[]'" v-model="option.answer">&nbsp;{{option.body}}
                  </label>
                </div>
              </div>

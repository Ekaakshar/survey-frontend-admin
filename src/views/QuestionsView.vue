      ...
      <div class="card read-only-question cursor_grab" v-if="selectedQuestion.id !== question.id">
        <div class="row">
          ...
          <div class="p-0 text-right">
            <button type="button" class="sb-btn-link mr-10 color-orange" @click="editQuestion(question, index)">Edit</button>
            <button type="button" class="sb-btn-link mr-10 color-red" @click="deleteQuestion(question, index)">Delete</button>
          </div>
        </div>
      </div>
    </div>

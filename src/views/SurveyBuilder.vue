    ...
    <div class="question-section" v-if="selectedType !== 'DEFAULT'">
      ...
      <div class="" v-if="selectedType === 'BOOLEAN'">
        ...
        <div class="" v-for="(option, index) in question.options" :key="index">
          <div class="clear-both">
            ...
            <button type="button" class="vsb-btn-link color-red width-10 mt-10" @click="deleteQuestionOptionItem(question.options, index)" v-if="index > 1">Remove</button>
          </div>
        </div>
      </div>
      ...
      <div class="" v-if="selectedType === 'MULTI_CHOICE'">
        ...
        <div class="display-block">
          <button type="button" class="vsb-btn-link color-blue" @click="addAnotherAnswer()">Add another answer</button>
        </div>
      </div>
      ...
      <div class="" v-if="selectedType === 'TIME'">
        <div class="">
          <label class=""><input type="radio" v-model="question.timeFormat" value="12" @click="timeFormatModified(question.timeFormat)"> 12 hrs</label>
          <label class=""><input type="radio" v-model="question.timeFormat" value="24" @click="timeFormatModified(question.timeFormat)"> 24 hrs</label>
        </div>
      </div>

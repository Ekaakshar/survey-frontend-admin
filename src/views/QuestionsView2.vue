        ...
        <div class="row">
          <div class="p-0">
            <div class="question-section">
              <p class="question_body">Q{{ index + 1 }}: {{question.body}}</p>
            </div>
            <div class="answer-section">
              <div class="option-section" v-if="question.type === 'BOOLEAN'">
                <div class="" v-for='(option, index) in question.options' :key="index">
                  <p class="radio-option">
                     <label>
                    <input type="radio" name="boolean_type" >
                   {{option.body}}</label>
                  </p>
                </div>
              </div>
              ...
              <div class="option-section" v-if="question.type === 'TIME'">
                <div class="p-0">
                  <input type="text" class="input-text readonly" placeholder="" :value="question.timeFormat === '12' ? 'HH:MM AM/PM':'HH:MM'" >
                </div>
              </div>
              <div class="option-section" v-if="question.type === 'NUMBER'">
                <div class="">
                  <input type="text" class="input-text readonly width-90" placeholder="" >
              ...
              <div class="option-section" v-if="question.type === 'SINGLE_CHOICE'">
                <div v-for='(option, index) in question.options' :key="index">
                  <label>
                    <input type="radio" name="single" >&nbsp;{{option.body}}
                  </label>
